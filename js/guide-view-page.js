(function () {
  ...
  function renderGuide(guide) {
    ...
    var canView = guide.status === "published" || isAuthor || TC.isAdmin();
    ...
    if (isAuthor && guide.status !== "pending") {
      editBtn = '<a href="guide-create.html?id=' + guide.id + '" class="tg-btn tg-btn--ghost" style="margin-top:1rem">Edit guide</a>';
    }
  ...
  function init() {
    ...
    var guide = TUG.getGuideById(guideId);
    if (!guide) {
